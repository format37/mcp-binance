...
# Binance MCP tools
register_binance_get_account(mcp, binance_client, CSV_DIR, REQUESTS_DIR)
register_binance_get_ticker(mcp, binance_client, CSV_DIR, REQUESTS_DIR)
register_binance_get_orderbook(mcp, binance_client, CSV_DIR, REQUESTS_DIR)
register_binance_get_recent_trades(mcp, binance_client, CSV_DIR, REQUESTS_DIR)
register_binance_get_price(mcp, binance_client, CSV_DIR, REQUESTS_DIR)
register_binance_get_book_ticker(mcp, binance_client, CSV_DIR, REQUESTS_DIR)
register_binance_get_avg_price(mcp, binance_client, CSV_DIR, REQUESTS_DIR)
register_binance_get_open_orders(mcp, binance_client, CSV_DIR, REQUESTS_DIR)
register_binance_spot_trade_history(mcp, binance_client, CSV_DIR, REQUESTS_DIR)
register_binance_get_deposit_history(mcp, binance_client, CSV_DIR, REQUESTS_DIR)
register_binance_get_withdrawal_history(mcp, binance_client, CSV_DIR, REQUESTS_DIR)
register_binance_get_p2p_history(mcp, binance_client, CSV_DIR, REQUESTS_DIR)
register_binance_get_historical_klines(mcp, binance_client, CSV_DIR, REQUESTS_DIR)
register_binance_spot_market_order(mcp, binance_client, CSV_DIR, REQUESTS_DIR)
register_binance_spot_limit_order(mcp, binance_client, CSV_DIR, REQUESTS_DIR)
register_binance_spot_oco_order(mcp, binance_client, CSV_DIR, REQUESTS_DIR)
register_binance_cancel_order(mcp, binance_client, CSV_DIR, REQUESTS_DIR)
register_binance_get_futures_balances(mcp, binance_client, CSV_DIR, REQUESTS_DIR)
register_binance_trade_futures_market(mcp, binance_client, CSV_DIR, REQUESTS_DIR)
register_binance_futures_limit_order(mcp, binance_client, CSV_DIR, REQUESTS_DIR)
...
register_binance_calculate_liquidation_risk(mcp, binance_client, CSV_DIR, REQUESTS_DIR)
